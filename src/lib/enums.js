...
var CorsairDeviceType = new Enum({
  CDT_Unknown: 0,
  CDT_Mouse: 1,
  CDT_Keyboard: 2,
  CDT_Headset: 3
...
var CorsairPhysicalLayout = new Enum({
  CPL_Invalid: 0,
  CPL_US: 1,
  CPL_UK: 2,
  CPL_BR: 3,
...
var CorsairLogicalLayout = new Enum({
  CLL_Invalid: 0,
  CLL_US_Int: 1,
  CLL_NA: 2,
  CLL_EU: 3,
...
module.exports = { CorsairLedId, CorsairDeviceCaps, CorsairPhysicalLayout, CorsairLogicalLayout, CorsairDeviceCaps, CorsairAccessMode, CorsairError };
